...
`,[z("input, textarea",`
 ...
 `),y("&:-webkit-autofill ~",[z("placeholder","display: none;")])]),T("round",[_e("textarea","border-radius: calc(var(--n-height) / 2);")]),z("placeholder",`
 pointer-events: none;
 position: absolute;
 left: 0;
 right: 0;
 ...
 width: 100%;
 display: inline-block;
 `)]),T("textarea",[z("placeholder","overflow: visible;")]),_e("autosize","width: 100%;"),T("autosize",[z("textarea-el, input-el",`
 position: absolute;
 top: 0;
 left: 0;
 height: 100%;
 ...
 display: flex;
 align-items: center; 
 `)])]),_e("textarea",[z("placeholder","white-space: nowrap;")]),z("eye",`
 transition: color .3s var(--n-bezier);
 ...
 `),["warning","error"].map(e=>T(`${e}-status`,[_e("disabled",[C("base-loading",`
...
`,[y("&:first-child",{marginTop:0}),T("prefix-bar",{position:"relative",paddingLeft:"var(--n-prefix-width)"},[T("align-text",{paddingLeft:0},[y("&::before",{left:"calc(-1 * var(--n-prefix-width))"})]),y("&::before",`
 ...
 bottom: 0;
 position: absolute;
 `),y("&::before",{backgroundColor:"var(--n-bar-color)"})])]),og=Object.assign(Object.assign({},re.props),{type:{type:String,default:"default"},prefix:String,alignText:Boolean}),tt=e=>X({name:`H${e}`,props:og,setup(o){const{mergedClsPrefixRef:t,inlineThemeDisabled:r}=we(o),n=re("Typography","-h",eg,ul,o,t),i=$(()=>{const{type:s}=o,{common:{cubicBezierEaseInOut:a},self:{headerFontWeight:c,headerTextColor:u,[D("headerPrefixWidth",e)]:f,[D("headerFontSize",e)]:v,[D("headerMargin",e)]:p,[D("headerBarWidth",e)]:h,[D("headerBarColor",s)]:m}}=n.value;return{"--n-bezier":a,"--n-font-size":v,"--n-margin":p,"--n-bar-color":m,"--n-bar-width":h,"--n-font-weight":c,"--n-text-color":u,"--n-prefix-width":f}}),l=r?ke(`h${e}`,$(()=>o.type[0]),i,o):void 0;return{mergedClsPrefix:t,cssVars:r?void 0:i,themeClass:l==null?void 0:l.themeClass,onRender:l==null?void 0:l.onRender}},render(){var o;const{prefix:t,alignText:r,mergedClsPrefix:n,cssVars:i,$slots:l}=this;return(o=this.onRender)===null||o===void 0||o.call(this),d(`h${e}`,{class:[`${n}-h`,`${n}-h${e}`,this.themeClass,{[`${n}-h--prefix-bar`]:t,[`${n}-h--align-text`]:r}],style:i},l)}});tt("1");const om=tt("2");tt("3");const tm=tt("4");tt("5");tt("6");const tg=C("text",`
 transition: color .3s var(--n-bezier);
 color: var(--n-text-color);
`,[T("strong",`
 font-weight: var(--n-font-weight-strong);
